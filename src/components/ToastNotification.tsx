...
const ToastNotification = () => {
  ...
  return (
    <div className={`${isActive.active ? 'block' && setTimeout(() => {setIsActive({productName: '', active: false})}, 1500) : 'hidden'} fixed bottom-[0%] left-[10%] md:left-[45%] -translate-y-7 animate-slideUP 
