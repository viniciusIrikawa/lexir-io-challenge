...
const ToastNotification = () => {
  ...
  return (
    <div className={`${isActive.active ? 'block' : 'hidden'} fixed bottom-[0%] left-[10%] md:left-[45%] -translate-y-7 animate-slideUP 
                    w-[80%] md:w-[18%] p-3 z-20 flex justify-around items-center 
