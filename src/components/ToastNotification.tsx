...
const ToastNotification = () => {
  ...
  return (
    <div className={`${isActive.active ? 'block' : 'hidden'} fixed bottom-[0%] left-[18%] md:left-[44%] -translate-y-7 animate-slideUP 
                    w-auto p-3 z-20 flex justify-around items-center 
