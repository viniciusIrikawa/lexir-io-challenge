  ...
  return (
    ...
    <header className='w-full border-b-4 py-2 md:py-7 px-4 md:px-12 flex flex-row justify-between items-center relative'>
        <button className='md:hidden focus:outline-none group'>
            ...
            <div className='fixed top-0 -left-full h-[100vh] w-8/12 bg-[#f7c4b5] border z-10 opacity-0 group-focus:left-0 group-focus:opacity-100 transition-all duration-500'>
                <div className='mt-10 mb-5 pb-3 border-b-2'>
                    <Link href={"/"}> 
                        <a className='text-2xl md:text-5xl font-serif'> Nice Beer </a>
                    </Link>
                </div>
                <ul className='flex flex-col px-3 uppercase'>
                    <li className='md:mx-5 my-1 text-left'>
                        <Link href={''}>
